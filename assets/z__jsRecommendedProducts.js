...
//         
        ...
        if ($product.length === 0) {
          ...
          if($productRecommendations.find('.slider-gallery').length > 0){
            $productRecommendations.find('.slider-gallery').owlCarousel({
              loop:false,
              margin:0,
            ...
            $productRecommendations.find('.slider-gallery .image__container').matchHeight();
            $productRecommendations.find('.slider-gallery .product-useful').matchHeight();
          }
