(function (window, k) {
    if (!window.AppstleIncluded && (!urlIsProductPage() || 'V1' === 'V2')) {
      ...
      appstleLoadScript("https://cdn.shopify.com/s/files/1/0508/7294/2769/t/19/assets/appstle-subscription.js?v=1678105824");
      ...
      RS.Config = {
        ...
        "atcButtonSelector": ".button.ajax-submit.action_button.button--add-to-cart.action_button--secondary",
        "moneyFormat": "{% raw %}${{amount}}{% endraw %}",
        "oneTimePurchaseText": "Single Pack",
        "shop": "buddy-pet-aus.myshopify.com",
        ...
        "css": {
            ...
            "customCSS": "",
            "customerPortalCss": "",
            "priceSelector": "div.price-selector__wrapper > p > span:nth-child(2)",
